...
[Step 11 핸즈온 랩](./11-handson-lab.md)에서 기본기를 익혔다면, 이 페이지는 **가상의 보안팀 인력이 실제 업무를 처음부터 끝까지 수행**하는 과정을 따라갑니다. 등장인물과 상황은 학습용 가상이지만, **모든 기능·프롬프트·제약은 Microsoft 공식 문서에 근거**합니다. 각 시나리오 끝에는 일반적으로 잘 모르는 활용법을 정리한 **고급 활용 팁** 박스가 있습니다.
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [11 · 핸즈온 랩](./11-handson-lab.md) | [99 · 부록](./99-troubleshooting.md) |
