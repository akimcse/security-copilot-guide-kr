...
> - 변경 검토·정책 구성·취약점 개선 에이전트의 실제 동작 데모 영상
>
...
<video controls preload="metadata" playsinline src="./media/intune-policy-config-agent.mp4"></video>

*Policy Configuration Agent 데모 — 자연어 요구사항을 설정 카탈로그 구성으로 번역*
...
<video controls preload="metadata" playsinline src="./media/intune-change-review-agent.mp4"></video>

*Change Review Agent 데모 — 변경의 위험·충돌·영향을 분석해 승인/반려 권장*
...
<video controls preload="metadata" playsinline src="./media/intune-vulnerability-remediation-agent.mp4"></video>

*Vulnerability Remediation Agent 데모 — CVE 탐지·위험 평가·패치 우선순위화*
