...
> [!WARNING]
> 이 랩의 모든 프롬프트·프롬프트북·플러그인·에이전트 실행은 **실제 SCU(Security Compute Unit)를 소비**합니다. 정식 출시(GA) 및 공개 프리뷰(Public Preview) 기능은 모두 과금 대상입니다. 실습 전 사용 가능한 용량과 오버리지 설정을 확인하세요(→ [Step 9: 사용량 모니터링](./09-usage-monitoring.md)).
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [10 · 책임 있는 AI](./10-responsible-ai.md) | [12 · 실무 활용](./12-use-cases.md) |
