[🏠 전체 목차](./README.md)　·　**Part 4 · 실습·활용**　·　페이지 12 / 14
...
이 핸즈온 랩은 **가상의 보안팀 인력이 실제 업무를 처음부터 끝까지 수행**하는 과정을 따라갑니다. 등장인물과 상황은 학습용 가상이지만, **모든 기능·프롬프트·제약은 Microsoft 공식 문서에 근거**합니다. 각 시나리오 끝에는 일반적으로 잘 모르는 활용법을 정리한 **고급 활용 팁** 박스가 있습니다.
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [10 · 책임 있는 AI](./10-responsible-ai.md) | [12 · 핸즈온 랩 2) CA 정책 최적화](./12-ca-agent-lab.md) |
