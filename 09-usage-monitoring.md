[🏠 전체 목차](./README.md)　·　**Part 3 · 운영과 거버넌스**　·　페이지 10 / 14

# 09 · 사용량 모니터링과 용량(SCU) 관리
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [08 · API 활용](./08-api-usage.md) | [10 · 책임 있는 AI](./10-responsible-ai.md) |
