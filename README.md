...
flowchart LR
    ...
    subgraph P2["Part 2 · 핵심 기능"]
        B3["03 포털·프롬프트"] --> B4["04 프롬프트북"] --> B5["05 플러그인"] --> B6["06 임베디드"] --> B7["07 에이전트"] --> B8["08 API 활용"]
    end
...
| [**08 · API 활용**](./08-api-usage.md) | Logic Apps로 프롬프트를 프로그래밍 호출 — 대시보드·티켓 연동 | 9분 |

### Part 3 · 운영과 거버넌스 — *안전하게 굴리려면*

| 페이지 | 이 페이지의 핵심 | 소요 |
| :-- | :-- | :--: |
| [**09 · 사용량 모니터링**](./09-usage-monitoring.md) | 용량 대시보드, SCU 소비·갱신·한도 동작 | 5분 |
| [**10 · 책임 있는 AI · 데이터 보안**](./10-responsible-ai.md) | 데이터 학습 미사용 보장, 레지던시, 보존, 6대 RAI 원칙 | 8분 |

### Part 4 · 실습과 활용 — *직접 해보고, 현업에 적용하고*
