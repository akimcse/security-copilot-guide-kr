...
> 📎 **예시 파일 내려받기**: [CA_Knowledge_Base_예시_한빛전자.docx](./assets/CA_Knowledge_Base_예시_한빛전자.docx) — 이 랩에서 실제로 업로드한 지식 원본 문서입니다. 그대로 열어 구조를 확인하거나, 아래 템플릿 섹션에 맞춰 자사 정책 문서로 바꿔 쓰세요.
