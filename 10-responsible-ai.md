[🏠 전체 목차](./README.md)　·　**Part 3 · 운영과 거버넌스**　·　페이지 11 / 14
...
| --- | --- | --- | --- |
| 데이터 저장 위치<br>(Data storage location) | Customer Data(프롬프트·응답 등)가 저장되는 geo | 워크스페이스 생성 시 **직접 선택** | M365 데이터가 저장되는 테넌트(Microsoft Entra) geo로 **자동 결정** |
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [09 · 사용량 모니터링](./09-usage-monitoring.md) | [11 · 핸즈온 랩](./11-handson-lab.md) |
